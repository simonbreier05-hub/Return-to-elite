 ...
 */
export const STATUS_STYLES: Record<RoomStatus, { chip: string; tile: string; dot: string; border: string; iconKey: "warning" | "clock" | "ban" | "check" }> = {
  DIRTY: {
    chip: "bg-status-dirty/10 text-status-dirty border-status-dirty/30",
    tile: "bg-status-dirty text-linen border-black/20",
    dot: "bg-status-dirty",
    border: "border-l-status-dirty",
    iconKey: "warning",
  },
  IN_PROGRESS: {
  ...
  INSPECTED: {
    ...
    border: "border-l-status-inspected",
    iconKey: "check",
  },
  PICKUP: {
  ...
  OUT_OF_ORDER: {
    ...
    border: "border-l-status-out-of-order",
    iconKey: "ban",
  },
  OUT_OF_SERVICE: {
    ...
    border: "border-l-status-out-of-service",
    iconKey: "ban",
  },
  GREEN_OPT_OUT: {
    ...
    border: "border-l-status-green-opt-out",
    iconKey: "check",
  },
};
