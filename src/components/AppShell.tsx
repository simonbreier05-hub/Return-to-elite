          ...
          <div className="flex items-center gap-2">
            <div className="relative hidden md:block">
              <input
                ...
                className="h-11 w-40 rounded-lg border border-charcoal/15 bg-parchment/50 px-3 text-sm text-charcoal outline-none transition-all placeholder:text-graphite/45 focus:w-56 focus:border-gold"
              />
            ...
            <Link
              href="/floor-plan"
              className="hidden h-10 items-center rounded-lg border border-charcoal/15 px-3 text-xs font-medium uppercase tracking-wider text-charcoal/75 transition hover:bg-parchment sm:flex"
